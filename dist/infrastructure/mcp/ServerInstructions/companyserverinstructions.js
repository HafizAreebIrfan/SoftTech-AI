...
exports.getCompanyMcpInstructions = void 0;
const getCompanyMcpInstructions = (company) => {
    return (`You are a dedicated MCP (Model Context Protocol) assistant for the company "${company.companyName}". ` +
...
exports.getCompanyMcpInstructions = getCompanyMcpInstructions;

...
export const useApplyGlobalThemeVars = () => {
  ...
  useEffect(() => {
    ...
    root.style.setProperty("--app-header-bottom-border", colors.HeaderBottomBorder);
    root.style.setProperty("--app-header-item-color", colors.HeaderItemColor);
    root.style.setProperty("--app-header-item-hover", colors.HeaderItemHoverColor);
    root.style.setProperty("--app-header-item-active", colors.HeaderItemActiveColor);
    ...
    root.style.setProperty("--app-ui-selection-card-background", colors.UISelectionCardBackground);
    ...
    root.style.setProperty("--app-card-border-secondary", colors.CardBorderSecondary);
    ...
    root.style.setProperty("--app-text-highlighted-heading", colors.TextHighlightedHeading);
    ...
    root.style.setProperty("--app-header-btn-grad-1", colors.HeaderButtonGradientOne);
    root.style.setProperty("--app-header-btn-grad-2", colors.HeaderButtonGradientTwo);
    root.style.setProperty("--app-header-btn-grad-text", colors.HeaderButtonGradientText);
    root.style.setProperty("--app-header-btn-secondary", colors.HeaderButtonSecondary);
    root.style.setProperty("--app-header-btn-secondary-text", colors.HeaderButtonSecondaryText);
    ...
    root.style.setProperty("--app-btn-pricing-secondary", colors.ButtonPricingSecondary);
    root.style.setProperty("--app-btn-pricing-secondary-text", colors.ButtonPricingSecondaryText);
    ...
    root.style.setProperty("--app-btn-overlay-secondary", colors.ButtonOverlaySecondary);
    root.style.setProperty("--app-btn-overlay-secondary-text", colors.ButtonOverlaySecondaryText);

    ...
    <div className={styles.flowShell} style={getAccountFlowThemeVars(colors)}>
      <header className={styles.topbar}>
        ...
        <nav className={styles.wizard}>
          ...
          <div className={styles.wizardItem}><span className={`${styles.wizardDot} ${styles.wizardDotDone}`}><CheckIcon size={16} color={colors.TextGradientOne} /></span><span className={styles.wizardCopy}><span className={styles.wizardKicker}>Step 2</span><span className={styles.wizardLabel}>Checkout</span></span></div>
          <span className={styles.wizardLine} />
          <div className={styles.wizardItem}><span className={`${styles.wizardDot} ${styles.wizardDotActive}`}>3</span><span className={styles.wizardCopy}><span className={`${styles.wizardKicker} ${styles.wizardKickerActive}`}>Current</span><span className={`${styles.wizardLabel} ${styles.wizardLabelActive}`}>Deployment</span></span></div>
        </nav>
      </header>
        ...
        <section className={`${styles.card} ${styles.resultCard}`}>
          ...
          <div style={{ marginTop: "2.5rem" }}>
            <button
              ...
              onClick={() => navigate({ to: "/deployment_in_progress_softtech_ai" })}
              type="button"
            >

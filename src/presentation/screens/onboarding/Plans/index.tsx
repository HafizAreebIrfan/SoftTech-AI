    ...
    <div className={styles.flowShell} style={getAccountFlowThemeVars(colors)}>
      <header className={styles.topbar}>
        ...
        <nav className={styles.wizard}>
          <div className={styles.wizardItem}><span className={`${styles.wizardDot} ${styles.wizardDotActive}`}>1</span><span className={styles.wizardCopy}><span className={`${styles.wizardKicker} ${styles.wizardKickerActive}`}>Current</span><span className={`${styles.wizardLabel} ${styles.wizardLabelActive}`}>Plans</span></span></div>
          <span className={styles.wizardLine} />
          <div className={styles.wizardItem}><span className={styles.wizardDot}>2</span><span className={styles.wizardCopy}><span className={styles.wizardKicker}>Step 2</span><span className={styles.wizardLabel}>Checkout</span></span></div>
          <span className={styles.wizardLine} />
